class JobsController < ApplicationController
  ...
  private
    ...
    def job_params
      params.expect(job: [ :title, :description, :secteur_id, :contrat_id, :jobfamily_id, :lieu, :datefin, :interimagence_ids => [], :company_ids => [], :publiqueinstition_ids => [], :plateformedemploi_ids => [] ])
    end
end
