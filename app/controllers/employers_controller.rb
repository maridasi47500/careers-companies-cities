class EmployersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @employer.update(employer_params)
        format.html { redirect_to @employer, notice: "Employer was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to employers_path, notice: "Employer was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def employer_params
      params.expect(employer: [ :name, :pic, :phone, :email, :company_ids => [], :publiqueinstitution_ids => [] ])
    end
end
